...
**Required input files** building_features.npy, building_rot_type.npz, combined_building_list.csv are generated by your data preprocessing pipeline (from resnet.py)
"""
